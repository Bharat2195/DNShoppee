...
public class EwalletReport extends Activity {

	static final String KEY_PinNo = "Entry_x0020_Date";
	static final String KEY_PackageName = "Trans_x0020_Type";
	static final String KEY_Registered_x0020_To = "Amount";
	static final String KEY_Registration_x0020_On = "Net_x0020_Amount";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		URL = "http://dnshoppee.com/mAndroid.aspx?MenuID=V&GID="+ preferences.getString(Login._name, "");

		XMLParser1 parser = new XMLParser1();
		String xml = parser.getXmlFromUrl(URL);
		Log.d("XML", xml);
		if (xml.trim().equalsIgnoreCase("No Data Found")) {
			Toast.makeText(EwalletReport.this, "No Data Found",
					Toast.LENGTH_LONG).show();
			showAlertDialog(context, "Warning", "Time Out, Try Again !!!",
					false);
			Log.d("XML", "DOCNo Data Found");
		} else if (xml.equals(" ")) {
			Toast.makeText(EwalletReport.this, "Time Out, Try Again !!!",
					Toast.LENGTH_LONG).show();
			...
			ReportClassfor4 adapter = new ReportClassfor4(
					EwalletReport.this, list1, list2, list3, list4);
