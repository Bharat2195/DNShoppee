...
public class ReportClassfor7 extends ArrayAdapter<String> {
	Activity context;
	...
	public final ArrayList<String> web7;

	public ReportClassfor7(Activity context, ArrayList<String> al1, ArrayList<String> al2, ArrayList<String> al3, ArrayList<String> al4, ArrayList<String> al5, ArrayList<String> al6, ArrayList<String> al7 ) {
		super(context, R.layout.reportfor7, al1);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rootview = inflater.inflate(R.layout.reportfor7, null,true);
		...
		TextView tx7 = (TextView) rootview.findViewById(R.id.r87);
		...
		if(position == 0){
			...
			tx7.setBackgroundResource(R.color.Pink);
		}
		...
		tx6.setText(web6.get(position));
		tx7.setText(web7.get(position));
		return rootview;
