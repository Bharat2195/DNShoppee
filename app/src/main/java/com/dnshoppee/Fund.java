...
public class Fund extends ActionBarActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_e_pocket_balance_1:
			...
			if (xml.trim().equalsIgnoreCase("No Data Found")) {
				Toast.makeText(Fund.this, "No Data Found", Toast.LENGTH_LONG)
						.show();
				Log.d("XML", "DOCNo Data Found");
			} else if (xml.equals(" ")) {
				Toast.makeText(Fund.this, "Time Out, Try Again !!!",
